    ...
    >
      <div className="card w-full max-w-md animate-slide-up">
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-stone-800">
          <h2 className="font-semibold text-stone-100 text-lg">Ligas</h2>
          <button
            onClick={onClose}
            className="text-stone-400 hover:text-stone-100 w-8 h-8 flex items-center justify-center rounded-lg hover:bg-stone-800 transition-colors"
          >
            ✕
          </button>
        </div>
        ...
        {/* Tabs */}
        <div className="flex gap-1 p-1 bg-stone-800 mx-5 mt-5 rounded-xl">
        ...
        <div className="p-5">
          {created ? (
            ...
            <div className="space-y-4 text-center">
              ...
              <div>
                <p className="text-stone-300 font-medium">Liga <span className="text-amber-400">"{created.name}"</span> creada</p>
                <p className="text-stone-400 text-sm mt-1">Comparte este código con tus amigos:</p>
              </div>
              <div className="bg-stone-800 border border-amber-500/30 rounded-xl p-4">
