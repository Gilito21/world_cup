...
export default function LeagueCreatedModal({ league, onClose }) {
  ...
  return createPortal(
    ...
    >
      <div className="bg-paper rounded-none sm:rounded-none shadow-2xl shadow-black/40 w-full max-w-md overflow-hidden animate-slide-up max-h-[calc(100dvh-1rem)] sm:max-h-[calc(100dvh-4rem)] flex flex-col">
        {/* Hero */}
        ...
        <div className="p-5 space-y-4 overflow-y-auto flex-1">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <div className="flex-1 bg-paper border border-ink/30 rounded-none p-3 text-center">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <p className="flex-1 text-xs text-ink/60 bg-paper rounded-none px-3 py-2.5 font-mono truncate">{inviteLink}</p>
          ...
          <button
            ...
            className="w-full bg-[#25D366] hover:bg-[#1ebe5b] active:bg-[#19a851] text-white font-semibold rounded-none py-3 flex items-center justify-center gap-2 text-sm shadow-sm transition-colors min-h-[44px]"
          >
