        ...
        <div className="card p-6">
          {step === 'done' ? (
            <div className="text-center space-y-3 py-4">
              ...
              <p className="text-stone-100 font-semibold">Contraseña actualizada</p>
              <p className="text-stone-400 text-sm">Redirigiendo al inicio de sesión…</p>
            </div>
          ) : (
            <>
              <h2 className="text-lg font-semibold text-stone-100 mb-1">Nueva contraseña</h2>
              <p className="text-stone-400 text-sm mb-5">Elige una contraseña nueva para tu cuenta.</p>

              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-1.5">Nueva contraseña</label>
                  <input
                    type="password"
                    className="input"
                ...
                <div>
                  <label className="block text-sm font-medium text-stone-300 mb-1.5">Confirmar contraseña</label>
                  <input
                    type="password"
                    className="input"
